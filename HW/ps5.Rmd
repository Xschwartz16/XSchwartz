...
```{r}
mr <- ggplot(marathon2, aes(x = marathon2$Year, y = marathon2$time_minutes_maleR)) + geom_point() + geom_smooth()+labs(x="Year", y= "Time (minutes)")

wr <- ggplot(marathon2, aes(x = marathon2$Year, y = marathon2$time_minutes_femaleR)) + geom_point() + geom_smooth()+labs(x="Year", y= "Time (minutes)")

mw <- ggplot(marathon2, aes(x = marathon2$Year, y = marathon2$time_minutes_maleW)) + geom_point() + geom_smooth()+labs(x="Year", y= "Time (minutes)")

ww <- ggplot(marathon2, aes(x = marathon2$Year, y = marathon2$time_minutes_femaleW)) + geom_point() + geom_smooth()+labs(x="Year", y= "Time (minutes)")
